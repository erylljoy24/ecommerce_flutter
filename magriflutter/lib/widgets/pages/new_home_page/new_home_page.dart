...
import 'package:magri/widgets/pages/new_home_page/new_home.dart';
...
class NewHomePage extends StatefulWidget {
  NewHomePage({Key? key, this.auth, this.userId, this.logoutCallback})
      : super(key: key);
